...
const MOCK_MESSAGES = [
  {
    ...
    initials: "ML",
    color: "#7C3AED",
    text: "Hey everyone, ready to grind? 💪",
    time: "2:01 PM",
    type: "text",
  },
  {
    ...
    initials: "ZA",
    color: "#10B981",
    text: "Let's go! Working on the focus room UI today",
    time: "2:02 PM",
    type: "text",
  },
  {
    ...
    initials: "",
    color: "",
    text: "Priya Kumar joined the room",
    time: "2:04 PM",
    type: "system",
  },
  {
    ...
    initials: "PK",
    color: "#F59E0B",
    text: "Hi all! Joining to work on my portfolio project",
    time: "2:05 PM",
    type: "text",
  },
  {
    ...
    initials: "AS",
    color: "#00E5FF",
    text: "Nice! I'm building out the backend socket events. Let's sync after 30min?",
    time: "2:06 PM",
    type: "text",
  },
];
    ...
    >
        ...
        >
          <div
            style={{
              ...
              height: large ? 72 : 48,
              borderRadius: "50%",
              background: `${participant.color}25`,
      ...
      >
        ...
        >
          ...
          {participant.videoOff && (
            <VideoOff size={10} color="var(--text-muted)" />
          )}
        </div>
      </div>
    </div>
...
useEffect(() => {
 ...
 const sendMessage = () => {
  ...
  const roomName =
    roomId === "r1"
      ? "Deep Work — Backend APIs"
      : roomId === "r2"
        ? "Design Sprint"
        : roomId === "r3"
          ? "Study Hall — Algorithms"
          : "Focus Room";
        ...
        >
          ...
          >
            ...
            >
              ...
              <circle
                ...
                fill="none"
                stroke={
                  timerRunning ? "var(--accent-cyan)" : "var(--border-bright)"
                }
                strokeWidth="4"
                strokeLinecap="round"
              ...
              <button
                ...
                style={{
                  ...
                  background: timerRunning
                    ? "var(--accent-rose)"
                    : "var(--accent-cyan)",
                  color: timerRunning ? "white" : "var(--bg-primary)",
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              <span>
                {AMBIENT_OPTIONS.find((a) => a.value === ambient)?.label ||
                  "Sound"}
              </span>
              <ChevronDown size={10} />
            </button>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            {["grid", "spotlight"].map((l) => (
              <button
                ...
                style={{
                  ...
                  borderColor:
                    layoutMode === l ? "var(--accent-cyan)" : "var(--border)",
                  background:
                    layoutMode === l ? "var(--accent-cyan-dim)" : "transparent",
                  color:
                    layoutMode === l
                      ? "var(--accent-cyan)"
                      : "var(--text-muted)",
            ...
            >
              <Hand
                size={11}
                color={handRaised ? "var(--accent-amber)" : "var(--text-muted)"}
              />
              {participants
                .filter((p) => p.speaking)
                .map((p) => p.name)
            ...
            >
              {participants.map((p, i) => (
                <VideoTile
                  key={p.id}
                  participant={
                    i === 0 ? { ...p, videoOff: !camOn, muted: !micOn } : p
                  }
                  isLocal={i === 0}
                />
              ))}
          ...
          {layoutMode === "spotlight" && (
            <div
              style={{ display: "flex", gap: 12, flex: 1, overflow: "hidden" }}
            >
              <div style={{ flex: 1 }}>
                <VideoTile
                  participant={{ ...participants[2], speaking: true }}
                  large={true}
                />
              </div>
              <div
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    color:
                      panel === p ? "var(--text-primary)" : "var(--text-muted)",
                    fontSize: 13,
                    fontFamily: "var(--font-display)",
                    fontWeight: 600,
              ...
              <div style={{ flex: 1, overflowY: "auto", padding: "12px" }}>
                ...
                {participants.map((p, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {p.videoOff && (
                        <VideoOff size={12} color="var(--text-muted)" />
                      )}
                    </div>
                  </div>
                ))}
                ...
                >
                  ...
                  {[
                    ...
                    {
                      label: "Messages sent",
                      value: messages.filter((m) => m.type !== "system").length,
                      icon: MessageSquare,
                    },
                    {
                      label: "Room capacity",
